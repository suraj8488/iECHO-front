      ...
      <div className="container">
        <div class="pageleft">
          ...
          <div class="continue">
            ...
            <button type="button" disabled id="Google">
          ...
          <div class="tc">
            <p>
              ...
              <a href="https://iecho.org/terms">Terms of Use</a> and
              <a href="https://iecho.org/privacy"> Privacy Policy</a>
            </p>
          </div>
          <Footer />
        </div>
        <div class="pageright">
          <div class="help">
            <a href="https://projectecho.notion.site/iECHO-Help-Center-1e3301587de24775a6abd9100f937682">
              ?
            </a>
          </div>
          <img src={welcomeimg} alt="" />
          <h1>
            Learn from Experts and Share <br />
            your Expertise
          </h1>
          <p>
            The ECHO model uses a hub-and-spoke <br /> knowledge-sharing
            approach
          </p>
        </div>
      </div>
